...
test(`User is set up under under the 'Medium' plan`, () => {
	expect.assertions(1)
		expect(
...
test(`Medium plan user's type is 'User'`, () => {
	expect.assertions(1)
		expect(
...
test(`'Medium' plan user is not a vendor contractor, company name is not 'Github'`, () => {
	expect(
